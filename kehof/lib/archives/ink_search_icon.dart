                    ...
                    Padding(
                        ...
                        child: TextField(
                          ...
                          decoration: InputDecoration(
                              labelText: "Insert Phone Number (eg. 0123456789)",
                              suffixIcon: Ink(
                                              ...
                                              if (documentSnapshot.exists) {
                                                Map<String, dynamic> data =
                                                    documentSnapshot.data()
                                                        as Map<String, dynamic>;
                                                store
                                                    .setKehofParticipantFactory(
                                                        data);

                                                store
                                                    .setSearchMemberFound(true);
                                              } else {
                                                store.setSearchMemberFound(
                                                    false);
                                                print(
